...
*/
	 ...
	 */
	$config['default_group']       = 'reseller_pribadi';
	 ...
	 * id not required.
	 **/
	$config['columns']             = array('nama_lengkap', 'nomor_ktp', 'tempat_lahir', 'tanggal_lahir', 'nomor_telepon_reseller', 'alamat_reseller', 'nama_organisasi','alamat_organisasi','nomor_telepon_organisasi','bank_id', 'nomor_rekening', 'nama_pemilik_rekening','tanggal_daftar_reseller', 'foto_profile','nama_toko','link_toko','paket_reseller_id','reseller_id','tanggal_kedaluwarsa_poin_reseller','token');
