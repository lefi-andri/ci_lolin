...
<?php #echo $tabel; ?>
<?php #echo anchor(base_url('admin/reseller/order/item/simpan'), 'Simpan Order', array('class' => 'btn btn-dark')); ?>

<?php echo form_open(base_url('backend/item_order/simpan_order')); ?>
...
<table id="datatable" class="table table-striped table-bordered">
  ...
  <tbody>
<?php
$data_produk = $this->session->userdata('prodsId');
$no = 1;
...
?>
    <tr>
      ...
      <td><?php echo $_POST['jumlah'][$key_produk]; ?></td>
...
<?php echo anchor(base_url('admin/reseller/order'), 'Batal', array('class' => 'btn btn-default btn-block')); ?>
<?php echo form_close(); ?>
