      ...
      <div class="x_content">
        ...
        <div class="row">
          <div class="col-md-8">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                ...
                <p><i>Gambar dengan format *.jpg, resolusi 1920px x 500px</i></p>
              </div>      
            </div>
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-4 control-label">Kelas Aktif</label>
              <div class="col-sm-8">
              <?php echo form_error('class_active'); ?>
                <label class="radio-inline">
                        <?php echo form_radio('class_active', '1', set_radio('class_active', '1', isset($form_value['class_active']) && $form_value['class_active'] == '1' ? TRUE : FALSE), array('class' => 'flat')); ?>
                    Ya</label>
                    <label class="radio-inline">
                        <?php echo form_radio('class_active', '0', set_radio('class_active', '0', isset($form_value['class_active']) && $form_value['class_active'] == '0' ? TRUE : FALSE), array('class' => 'flat')); ?>
                    Tidak</label>
                </div>
            </div>
