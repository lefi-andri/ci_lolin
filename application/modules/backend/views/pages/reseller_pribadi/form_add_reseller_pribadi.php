...
<div class="form-group">
  ...
  <div class="col-sm-10">
    ...
    <?php echo form_dropdown('paket_id', $dropdown_paket_reseller, set_value('paket_id', isset($form_value['paket_id']) ? $form_value['paket_id'] : ''), array('class' => 'form-control')); ?>
  </div>
</div>
...
<div class="form-group">
      ...
      <div class="col-sm-1">
            <?php echo form_dropdown('tanggal', $dropdown_tanggal, set_value('tanggal', isset($form_value['tanggal']) ? $form_value['tanggal'] : ''), array('class' => 'form-control' )); ?>
      </div>
      <div class="col-sm-1">
            <?php echo form_dropdown('bulan', $dropdown_bulan, set_value('bulan', isset($form_value['bulan']) ? $form_value['bulan'] : ''), array('class' => 'form-control' )); ?>
      </div>
      <div class="col-sm-2">
            <?php echo form_dropdown('tahun', $dropdown_tahun, set_value('tahun', isset($form_value['tahun']) ? $form_value['tahun'] : ''), array('class' => 'form-control' )); ?>
      </div>
...
<div class="form-group">
      ...
      <p>
            ...
            <?php echo form_submit('submit', "Simpan", array('class'=>'btn btn-dark brn-sm')); ?></p>
      </div>
</div>
