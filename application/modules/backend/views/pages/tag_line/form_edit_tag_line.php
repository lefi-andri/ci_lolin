      ...
      <div class="x_content">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            ...
            <?php 
            $konten = set_value('konten', isset($form_value['konten']) ? $form_value['konten'] : '');
            ?>
        ...
        <div class="form-group">
          <label for="inputEmail3" class="col-sm-2 control-label">Tampilkan Tagline</label>
          <div class="col-sm-10">
