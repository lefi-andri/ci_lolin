...
<div class="row">
	<div class="col-12">
		...
		<div class="form-group">
			<label for="inputEmail3">Urutan Product *</label>
		...
		<div class="row">
			<label for="inputEmail3">Harga Diskon 1*</label>
			<div class="col-sm-2">
				<?php  
		...
		<div class="row">
			<label for="inputEmail3">Harga Diskon 2*</label>
			<div class="col-sm-2">
				<?php  
				$produk_id = $form_value['prodsId'];
		...
		<div class="row">
			<label for="inputEmail3">Harga Diskon 3*</label>
			<div class="col-sm-2">
				<?php  
				$produk_id = $form_value['prodsId'];
		...
		<div class="row">
			<label for="inputEmail3">Harga Diskon 4*</label>
			<div class="col-sm-2">
				<?php  
				$produk_id = $form_value['prodsId'];
		...
		<div class="row">
			<label for="inputEmail3">Harga Diskon 5*</label>
			<div class="col-sm-2">
				<?php  
				$produk_id = $form_value['prodsId'];
		...
		<div class="row">
			<label for="inputEmail3">Harga Diskon 6*</label>
			<div class="col-sm-2">
				<?php  
				$produk_id = $form_value['prodsId'];
		...
		<div class="form-group">
			<label for="inputEmail3">Merchant *</label>
				...
				if ((!empty($form_value['merchant'])) and ($form_value['merchant'] !="N;")) {
					...
					foreach ($data_merchant->result() as $key => $value) {
						...
						?>
							<label>
								<input name="merchant[]" type="checkbox" class='' value="<?php echo $value->id_merchant; ?>" checked> <?php echo $value->nama_merchant; ?>
							</label>
						<?php
						}else{
						?>
				...
				?>
					<label>
						<input name="merchant[]" type="checkbox" class='' value="<?php echo $value_null->id_merchant; ?>"> <?php echo $value_null->nama_merchant; ?>
					</label>
				<?php
					}
				}
