...
class Item_order_reseller_pribadi extends Backend_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('item_order_reseller_pribadi_model', 'models');
	}
	...
	public function add_item_order()
	{
		...
		$this->data = array(
			'main_view' => 'item_order_reseller_pribadi/form_add_item_order',
	...
	public function check_orders()
	{
		if (count($_POST['product']) == 0) {
	        ...
	        $data = array(
	            ...
	            'main_view'         => 'item_order_reseller_pribadi/list_input_jumlah_pembelian',
	        );
	...
	public function confirmation_order(){
		...
		if ($this->input->post('prodsId[]') == "") {
	        ...
	        $data = array(
	            'main_view'         => 'item_order_reseller_pribadi/list_order_confirmation',
	        );
	...
	public function edit_item_order($id)
	{
		...
		$this->data = array(
			'main_view' 		=> 'item_order_reseller_pribadi/form_edit_item_order',
		);
	...
	public function update_diskon(){
		...
		$this->data = array(
			'main_view' 		=> 'item_order_reseller_pribadi/list_edit_order_confirmation',
		);
	...
	public function simpan_update(){
		...
		if (isset($_POST['submit'])) {
				...
				redirect(base_url('backend/order_reseller_pribadi/index'),'refresh');
...
/* End of file Item_order_reseller_pribadi.php */
/* Location: ./application/modules/backend/controllers/Item_order_reseller_pribadi.php */