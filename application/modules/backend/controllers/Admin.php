...
class Admin extends Backend_Controller {
	...
	public function index(){
		...
		//set view
		$this->stencil->paint('admin/list_admin',$data);
		/*
		if (!$this->ion_auth->logged_in())
		{
			redirect('login/auth/index','refresh');
	...
	public function add_admin()
	{
		...
		*/
		...
		//set title
		$this->stencil->title('Tambah Admin');
		//set layout
		$this->stencil->layout('backend_layout');
		//set css
		//$this->stencil->css('bootstrap/bootstrap.min');
		...
		if (isset($_POST['submit'])){
			...
			if ($this->ion_auth->email_check($email))
			{
				...
				//set view
				$this->stencil->paint('admin/form_add_admin',$this->data);
			}else{
		...
		if (isset($_POST['submit'])){
			...
			if ($this->form_validation->run() == true){
				...
				if ($this->ion_auth->email_check($email))
				{
					$this->data['pesan_error'] = "Email telah digunakan";
					//set view
					$this->stencil->paint('admin/form_edit_admin',$this->data);
				}else{
	...
	public function deactivate($id = NULL)
	{
		...
		//set title
		$this->stencil->title('Deaktivasi Admin');
		//set layout
		$this->stencil->layout('backend_layout');
		//set css
		//$this->stencil->css('bootstrap/bootstrap.min');
		...
		if ($this->form_validation->run() == FALSE)
		{
			//set data
			$this->data = array(
				'label'			=> "Deaktivasi Admin",
				'form_action' => "backend/admin/deactivate/$id",
				'csrf' => $this->_get_csrf_nonce(),
				'user' => $this->ion_auth->get_user_array($id),
			);
			//set view
			$this->stencil->paint('admin/deactivate_user',$this->data);
