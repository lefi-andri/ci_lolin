...
class Flyer extends Backend_Controller {
	...
	public function index()
	{
		...
		//set view
		$this->stencil->paint('flyer/list_flyer',$data);
	}
	...
	public function add(){
		//set title
		$this->stencil->title('Tambah Flyer');
		//set layout
		$this->stencil->layout('backend_layout');
		//set css
		//$this->stencil->css('bootstrap/bootstrap.min');
		...
		if (isset($_POST['submit'])) {
			if ($this->form_validation->run() == FALSE) {
				...
				//set view
				$this->stencil->paint('flyer/form_add_flyer',$this->data);
	...
	public function edit($id = NULL){
		...
		if (isset($_POST['submit'])) {
			if ($this->form_validation->run() == FALSE) {
				...
				//set view
				$this->stencil->paint('flyer/form_edit_flyer',$this->data);
