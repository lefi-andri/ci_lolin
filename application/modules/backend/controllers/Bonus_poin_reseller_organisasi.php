...
class Bonus_poin_reseller_organisasi extends Backend_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('bonus_poin_reseller_organisasi_model', 'models');
	}
	...
	public function index()
	{
		...
		foreach ($data_bonus_poin->result() as $value) {
			$this->table->add_row(array(
				...
				anchor(base_url()."backend/bonus_poin_reseller_organisasi/edit_bonus_poin/$value->bonus_poin_id", '<span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Edit', array('class'=>'btn btn-dark btn-xs')).' '.
				anchor(base_url()."backend/bonus_poin_reseller_organisasi/delete_bonus_poin/$value->bonus_poin_id", '<span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Delete', array('class'=>'btn btn-danger btn-xs', 'onclick' => "return confirm('Anda yakin ingin menghapus data $value->nama_jenis_bonus ?')")),
			));
			$no++;
		}
		...
		$this->data = array(
			'main_view' 		=> 'bonus_poin_reseller_organisasi/list_bonus_poin',
	...
	public function add_bonus_poin()
	{
		...
		$this->data = array(
			'main_view' 	=> 'bonus_poin_reseller_organisasi/form_add_bonus_poin',
			'form_action' 	=> 'backend/bonus_poin_reseller_organisasi/add_bonus_poin',
		);
	...
	public function edit_bonus_poin($id)
	{
		...
		$this->data = array(
			'main_view' 	=> 'bonus_poin_reseller_organisasi/form_edit_bonus_poin',
			'form_action' 	=> "backend/bonus_poin_reseller_organisasi/edit_bonus_poin/$id",
		);
...
/* End of file Bonus_poin_reseller_organisasi.php */
/* Location: ./application/modules/backend/controllers/Bonus_poin_reseller_organisasi.php */