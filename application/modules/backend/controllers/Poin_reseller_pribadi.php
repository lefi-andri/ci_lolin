...
class Poin_reseller_pribadi extends Backend_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('poin_reseller_pribadi_model', 'models');
	}
	...
	public function index()
	{
		...
		foreach ($users as $value_user) {
			...
			$this->table->add_row(
				$no,
				anchor(base_url().'backend/rekaman_order_reseller_pribadi/data_rekaman/'.$value_user->id, $value_user->nama_lengkap, array(''=>'')),
				$total_semua_poin,
		...
		$data = array(
			'main_view' => 'poin_reseller_pribadi/list_poin',
...
/* End of file Poin_reseller_pribadi.php */
/* Location: ./application/modules/backend/controllers/Poin_reseller_pribadi.php */