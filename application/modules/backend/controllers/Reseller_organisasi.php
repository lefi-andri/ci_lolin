...
class Reseller_organisasi extends Backend_Controller {
	...
	public function index(){
		//set title
		$this->stencil->title('Distributor');
		//set layout
		...
		//set view
		$this->stencil->paint('reseller_organisasi/list_reseller_organisasi',$data);
	...
	public function add_reseller_organisasi()
	{
		...
		//set title
		$this->stencil->title('Tambah Distributor');
		//set layout
		$this->stencil->layout('backend_layout');
		//set css
		//$this->stencil->css('bootstrap/bootstrap.min');
		...
		if (isset($_POST['submit'])){
			...
			if ($this->ion_auth->email_check($email))
			{
				...
				//set view
				$this->stencil->paint('reseller_organisasi/form_add_reseller_organisasi',$this->data);
			}else{
	...
	public function edit_user($id)
	{
		...
		*/
		...
		//set title
		$this->stencil->title('Edit Distributor');
		//set layout
		$this->stencil->layout('backend_layout');
		//set css
		//$this->stencil->css('bootstrap/bootstrap.min');
		...
		if (isset($_POST['submit'])){
			...
			if ($this->form_validation->run() == true){
				...
				if ($this->ion_auth->email_check($email))
				{
					$this->data['pesan_error'] = "Email telah digunakan";
					//set view
					$this->stencil->paint('reseller_organisasi/form_edit_reseller_organisasi',$this->data);
				}else{
	...
	function deactivate($id = NULL)
	{
		...
		//set title
		$this->stencil->title('Deaktivasi Distributor');
		//set layout
		$this->stencil->layout('backend_layout');
		//set css
		//$this->stencil->css('bootstrap/bootstrap.min');
		...
		{
			$this->data = array(
				'label'			=> "Deaktivasi Distributor",
				'form_action' => "backend/admin/deactivate/$id",
				'csrf' => $this->_get_csrf_nonce(),
				'user' => $this->ion_auth->get_user_array($id),
			);
			//set view
			$this->stencil->paint('reseller_organisasi/deactivate_reseller_organisasi',$this->data);
