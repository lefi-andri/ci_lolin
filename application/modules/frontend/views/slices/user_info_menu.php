<aside class="user-info-wrapper">
  ...
  <div class="user-info">
    <div class="user-avatar"><a class="edit-avatar" href="<?php echo base_url('member/photo_profile'); ?>"></a><img src="<?php echo base_url(); ?>assets/images/foto_profile/<?php echo ($foto)? 'middle_'.$foto : 'user.png'; ?>" alt="Foto Profil"></div>
    <div class="user-data">
...
<nav class="list-group">
  <a class="list-group-item <?php if ($this->uri->segment(2) == 'dashboard'){ echo 'active';} ?>" href="<?php echo base_url('member/dashboard'); ?>"><i class="fa fa-dashboard"></i> Dashboard</a>
  <a class="list-group-item <?php if ($this->uri->segment(2) == 'profile'){ echo 'active';} ?>" href="<?php echo base_url('member/profile'); ?>"><i class="fa fa-user"></i> Profile</a>
  <a class="list-group-item with-badge" href="<?php echo base_url('member/order'); ?>"><i class="fa fa-cart-plus"></i> My Order</a>
  <a class="list-group-item with-badge" href="<?php echo base_url('member/poin'); ?>"><i class="fa fa-cart-plus"></i> Poin</a>
  <a class="list-group-item with-badge" href="<?php echo base_url('member/redeem'); ?>"><i class="icon-head"></i>Redeem</a>
