    ...
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        <div align="right">
			...
			<?php echo anchor('backend/kategori_blog/add', '<span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Tambah Kategori Blog', array('class' => 'btn btn-dark btn-sm' )); ?>
		</div>
