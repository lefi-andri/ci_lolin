<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Edit reseller organisasi</h2>
...
<div class="form-group">
  ...
  <div class="col-sm-10">
    ...
    <?php echo form_dropdown('paket_id', $dropdown_paket_distributor, set_value('paket_reseller_id', isset($form_value['paket_reseller_id']) ? $form_value['paket_reseller_id'] : ''), array('class' => 'form-control')); ?>
  </div>
</div>
...
<div class="form-group">
      <label for="" class="col-sm-2 control-label">Nama Perwakilan:</label>
      <div class="col-sm-10">
