...
<br>
<?php  
if ($data_reseller->group == 'reseller_organisasi') {
?>
<div>
	<b>Data reseller</b>
</div>
<table width="400px" border="0" style="border-collapse: collapse;">
  ...
  <tr>
    ...
    <td>:</td>
    <td><?php echo $data_reseller->nama_organisasi; ?></td>
  </tr>
  <tr>
    <td>Alamat Organisasi</td>
    <td>:</td>
    <td><?php echo $data_reseller->alamat_organisasi; ?></td>
  </tr>
  <tr>
    <td>Nomor Telepon Organisasi</td>
    <td>:</td>
    <td><?php echo $data_reseller->nomor_telepon_organisasi; ?></td>
  </tr>
  <tr>
    <td>Nama Lengkap</td>
    <td>:</td>
