    ...
    <div class="x_panel">
      ...
      <div class="x_content">
        <p class="text-muted font-13 m-b-30">
          Halaman ini untuk mengatur event website.
        </p>
            ...
            <div align="right">
            	...
            	<?php echo anchor('admin/event/add', '<span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Tambah Events', array('class' => 'btn btn-dark btn-sm' )); ?>
            </div>
