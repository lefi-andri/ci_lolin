    ...
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        <div align="right">
			...
			<?php echo anchor('backend/konten_halaman/add', '<span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Tambah Konten Halaman', array('class' => 'btn btn-dark btn-sm' )); ?>
		</div>
